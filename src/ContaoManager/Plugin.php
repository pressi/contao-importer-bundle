...
namespace PRESTEP\ImporterBundle\ContaoManager;


use PRESTEP\ImporterBundle\PRESTEPImporterBundle;
...
class Plugin implements BundlePluginInterface, RoutingPluginInterface, ConfigPluginInterface, DependentPluginInterface
{
    ...
    public function getBundles(ParserInterface $parser)
    {
        ...
        return [
            BundleConfig::create(PRESTEPImporterBundle::class)
